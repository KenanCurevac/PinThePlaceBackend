...
async function seed() {
  await prisma.question.createMany({
    data: [
      {
        question:
          "Where is the oldest continuously inhabited city in the world?",
        answer: "Damascus",
        lat: 33.5138,
        lng: 36.2765,
      },
      ...
      {
        question:
          "In which city is the global headquarters of Samsung located?",
        answer: "Seoul",
        lat: 37.5665,
        lng: 126.978,
      },
      {
        question:
          "In which city is the global headquarters of Coca-Cola located?",
        answer: "Atlanta",
        lat: 33.749,
        lng: -84.388,
      },
      ...
      {
        question:
          "Where did the assassination that triggered World War I take place?",
        answer: "Sarajevo",
        lat: 43.8563,
        lng: 18.4131,
      },
      {
        question:
          "Where is the site of the first modern Olympic Games held in 1896?",
        answer: "Athens",
        lat: 37.9838,
        lng: 23.7275,
      },
      {
        question:
          "Where is the location of the first atomic bomb drop in history?",
        answer: "Hiroshima",
        lat: 34.3853,
        lng: 132.4553,
      },
      ...
      {
        question:
          "In which city is Shakespeare's tragedy about Romeo and Juliet set?",
        answer: "Verona",
        lat: 45.4384,
        lng: 10.9916,
      },
      ...
      {
        question:
          "Where is the only Grand Slam tennis tournament played on grass?",
        answer: "Wimbledon",
        lat: 51.4343,
        lng: -0.214,
      },
      ...
      {
        question:
          "At which mountain pass did 300 Spartans fight the Persian army in 480 BC?",
        answer: "Thermopylae",
        lat: 38.7969,
        lng: 22.5361,
      },
      ...
      {
        question:
          "Where did the largest tank battle in history occur during World War II?",
        answer: "Kursk",
        lat: 51.73,
        lng: 36.192,
      },
      ...
      {
        question:
          "Which islands did Charles Darwin study that were key to his theory of evolution?",
      ...
      {
        question:
          "In which city is the Formula 1 race held entirely on public streets?",
        answer: "Monaco",
        lat: 43.7336,
        lng: 7.4206,
      },
      ...
      {
        question:
          "At which archaeological site was the Minotaur said to live in a labyrinth?",
      ...
      {
        question:
          "Near which modern-day city was the ancient city of Carthage located?",
        answer: "Tunis",
        lat: 36.8529,
        lng: 10.3239,
      },
      {
        question:
          "Which city did Alexander the Great found and name after himself?",
        answer: "Alexandria",
        lat: 31.2001,
        lng: 29.9187,
      },
      ...
      {
        question:
          "In which city was U.S. President John F. Kennedy assassinated in 1963?",
        answer: "Dallas",
        lat: 32.7767,
        lng: -96.797,
      },
      ...
      {
        question:
          "In which city are the annual Academy Awards, also known as the Oscars, presented?",
        answer: "Los Angeles",
        lat: 34.102,
        lng: -118.34,
      },
